...
export default function Nav() {
    ...
    return (
        <nav className="flex py-3 px-20 justify-between shadow-xl bg-slate-200">
            <ul className="flex gap-20">
                <li className="text-xl text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"><a href='/home'>Home</a></li>
